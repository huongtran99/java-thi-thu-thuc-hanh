...
public class MenuProduct {
    ...
    static {
        productManagement.addNew(new Product("1", "Cơm", 10.5, 1, "Ngon"));
        productManagement.addNew(new Product("2", "Áo", 100.5, 1, "Ngon"));
        productManagement.addNew(new Product("3", "Gạo", 11.5, 1, "Ngon"));
        productManagement.addNew(new Product("4", "Tiền", 1000, 1, "Ngon"));
        productManagement.addNew(new Product("5", "Cứt", 0, 1, "Ngon"));
        productManagement.addNew(new Product("6", "Chó", 5, 1, "Ngon"));
    }
